#ifndef _BHMCTRLCP_H_
#define _BHMCTRLCP_H_

template <class T>
class CProxy_IBHMTimeEditCtrlEvents : public IConnectionPointImpl<T, &DIID__IBHMTimeEditCtrlEvents, CComDynamicUnkArray>
{
